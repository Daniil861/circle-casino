(() => {
    ...
    function initSliders() {
        if (document.querySelector(".content__slider")) new core(".content__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    if (sessionStorage.getItem("gold_point")) {
    ...
    if (document.querySelector(".game")) {
        ...
        if ("2" == sessionStorage.getItem("active-knife")) document.querySelector(".item-game__knife_two").classList.remove("_hide");
        if ("3" == sessionStorage.getItem("active-knife")) document.querySelector(".item-game__knife_three").classList.remove("_hide");
    ...
    if (document.querySelector(".content")) {
        ...
        if (sessionStorage.getItem("knife2")) {
            document.querySelector(".content__knife_four").classList.remove("_lock");
            document.querySelector(".content__knife_four img").classList.remove("_lock");
        }
        if (sessionStorage.getItem("knife3")) {
            document.querySelector(".content__knife_one").classList.remove("_lock");
            document.querySelector(".content__knife_one img").classList.remove("_lock");
        }
        if (sessionStorage.getItem("knife4")) {
            document.querySelector(".content__knife_three").classList.remove("_lock");
            document.querySelector(".content__knife_three img").classList.remove("_lock");
        }
    }
    if (document.querySelector(".shop")) {
        if (sessionStorage.getItem("knife2")) document.querySelector('[data-marker="2"]').classList.add("_buy");
        if (sessionStorage.getItem("knife3")) document.querySelector('[data-marker="3"]').classList.add("_buy");
        if (sessionStorage.getItem("knife4")) document.querySelector('[data-marker="4"]').classList.add("_buy");
    }
    document.addEventListener("click", (e => {
        let targetElement = e.target;
        if (targetElement.closest(".acces-preloader__button_apply")) {
        ...
        if (targetElement.closest(".item-game__circle-hiden-button")) if (count >= 0 && count < 5) {
            ...
            document.querySelector(".item-game__circle-hiden-button").style.pointerEvents = "none";
            setTimeout((() => {
                document.querySelector(".item-game__circle-hiden-button").style.pointerEvents = "fill";
            }), 2500);
            setTimeout((() => {
                let arrow_top = arrow.getBoundingClientRect().top;
                let arrow_left = arrow.getBoundingClientRect().left;
                ...
                if (target_block.closest(".peace-7")) {
                    document.querySelector(".knife-peace-7").style.opacity = "1";
                    sessionStorage.setItem("knife2", true);
                }
                ...
                if (count < 5) {
                    ...
                    bullet.forEach(((item, index) => {
                        if (index == count) item.classList.add("_active");
                    }));
                ...
                if (4 == count) document.querySelector(".item-game__min-knife_four").classList.add("_hide"); else if (5 == count) {
                    ...
                    if (sessionStorage.getItem("gold_point") >= 10) ; else {
                        document.querySelector(".content__button_back").classList.add("_visible");
                        document.querySelector(".content__button").style.opacity = "0.3";
                        document.querySelector(".content__button").style.pointerEvents = "none";
                    }
                }
            }), 2e3);
            if ("1" == sessionStorage.getItem("active-knife")) {
                if (pin_one.classList.contains("_visible")) pin_one.classList.remove("_visible");
                setTimeout((() => {
                    pin_one.classList.add("_visible");
                }), 1e3);
            } else if ("2" == sessionStorage.getItem("active-knife")) {
                if (pin_two.classList.contains("_visible")) pin_two.classList.remove("_visible");
                setTimeout((() => {
                    pin_two.classList.add("_visible");
                }), 1e3);
            } else if ("3" == sessionStorage.getItem("active-knife")) {
                if (pin_three.classList.contains("_visible")) pin_three.classList.remove("_visible");
                setTimeout((() => {
                    pin_three.classList.add("_visible");
                }), 1e3);
            } else if ("4" == sessionStorage.getItem("active-knife")) {
                if (pin_four.classList.contains("_visible")) pin_four.classList.remove("_visible");
                setTimeout((() => {
        ...
        if (targetElement.closest(".content__button") && document.querySelector(".content")) {
            ...
            if ("2" == document.querySelector(".swiper-slide-active").dataset.marker) if (sessionStorage.getItem("knife2")) sessionStorage.setItem("active-knife", 2); else sessionStorage.setItem("active-knife", 1);
            if ("3" == document.querySelector(".swiper-slide-active").dataset.marker) if (sessionStorage.getItem("knife3")) sessionStorage.setItem("active-knife", 3); else sessionStorage.setItem("active-knife", 1);
            if ("4" == document.querySelector(".swiper-slide-active").dataset.marker) if (sessionStorage.getItem("knife4")) sessionStorage.setItem("active-knife", 4); else sessionStorage.setItem("active-knife", 1);
            location.href = "game.html";
        }
        if (targetElement.closest(".content__button_play")) {
            let b = +points.innerHTML;
            if (sessionStorage.getItem("gold_point") >= 10) sessionStorage.setItem("gold_point", b - 10);
        }
        if (targetElement.closest(".shop__button") && !targetElement.classList.contains("shop__button_gray")) if (+points.innerHTML >= +targetElement.closest(".shop__item").dataset.cost) {
            let a = +targetElement.closest(".shop__item").dataset.cost;
            let b = +points.innerHTML;
            points.innerHTML = b - a;
            sessionStorage.setItem("gold_point", b - a);
            targetElement.closest(".shop__item").classList.add("_buy");
            if ("2" == targetElement.closest(".shop__item").dataset.marker) sessionStorage.setItem("knife2", true);
            if ("3" == targetElement.closest(".shop__item").dataset.marker) sessionStorage.setItem("knife3", true);
            if ("4" == targetElement.closest(".shop__item").dataset.marker) sessionStorage.setItem("knife4", true);
        } else {
            document.querySelector(".header__block-text").classList.add("_anim");
            setTimeout((() => {
                document.querySelector(".header__block-text").classList.remove("_anim");
            }), 3e3);
        }
    }));
    window["FLS"] = true;
